...
console.log(color('Halo, selamat menggunakan DY bot', 'purple'))
rifza.logger.level = 'warn'
rifza.version = [2, 2143, 3]
CFonts.say('auddy-bot\nWhatsAppBot', {
  font: 'chrome',
  align: 'center',
  gradient: ['blue', 'white']
})
CFonts.say(`@auddy-genss`, {
  font: 'console',
  align: 'center',
  gradient: ['red', 'magenta']
})
rifza.browserDescription = [ 'DY', 'Aloha', '5.4' ]    
...
console.log(bgcolor('XILVER - MOODS ©WhatsApp_Bot • Created By > [ ®Lord_Auddy ]\n-------> Ready to use❗', 'gray'))
//
await sleep(3000)
